...
export default class Resources extends EventEmitter
{
    constructor()
    {
        ...
        this.loader.load([
            ...
            //add model path here and name it

            { name: 'introVBase', source: './models/intro/V/base.glb' },
            { name: 'introVCollision', source: './models/intro/V/collision.glb' },

            { name: 'introI1Base', source: './models/intro/I1/base.glb' },
            { name: 'introI1Collision', source: './models/intro/I1/collision.glb' },

            { name: 'introR1Base', source: './models/intro/R1/base.glb' },
            { name: 'introR1Collision', source: './models/intro/R1/collision.glb' },

            { name: 'introA1Base', source: './models/intro/A1/base.glb' },
            { name: 'introA1Collision', source: './models/intro/A1/collision.glb' },
            ...
            { name: 'introH1Base', source: './models/intro/H1/base.glb' },
            { name: 'introH1Collision', source: './models/intro/H1/collision.glb' },

            { name: 'introI2Base', source: './models/intro/I2/base.glb' },
            { name: 'introI2Collision', source: './models/intro/I2/collision.glb' },

            // { name: 'introDBase', source: './models/intro/D/base.glb' },
            // { name: 'introDCollision', source: './models/intro/D/collision.glb' },
            
            // { name: 'introA2Base', source: './models/intro/A2/base.glb' },
            // { name: 'introA2Collision', source: './models/intro/A2/collision.glb' },
            
            // { name: 'introKBase', source: './models/intro/K/base.glb' },
            // { name: 'introKCollision', source: './models/intro/K/collision.glb' },

            // { name: 'introH2Base', source: './models/intro/H2/base.glb' },
            // { name: 'introH2Collision', source: './models/intro/H2/collision.glb' },

            // { name: 'introA3Base', source: './models/intro/A3/base.glb' },
            // { name: 'introA3Collision', source: './models/intro/A3/collision.glb' },
            ...
            { name: 'projectsDistinctions1LAKHBase', source: './models/projects/distinctions/1lakh/base.glb' },
            { name: 'projectsDistinctions1LAKHCollision', source: './models/projects/distinctions/1lakh/collision.glb' },

            { name: 'projectsDistinctions5THBase', source: './models/projects/distinctions/5th/base.glb' },
            { name: 'projectsDistinctions5THCollision', source: './models/projects/distinctions/5th/collision.glb' },

...
export default class IntroSection
{
    ...
    setTitles()
    {
        // Title
        this.objects.add({
            base: this.resources.items.introVBase.scene,
            collision: this.resources.items.introVCollision.scene,
            offset: new THREE.Vector3(0, 0, 0),
            rotation: new THREE.Euler(0, 0, 0),
        ...
        this.objects.add({
            base: this.resources.items.introI1Base.scene,
            collision: this.resources.items.introI1Collision.scene,
            offset: new THREE.Vector3(0, 0, 0),
            rotation: new THREE.Euler(0, 0, 0),
            shadow: { sizeX: 1.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.4 },
            mass: 1.5,
        ...
        this.objects.add({
            base: this.resources.items.introR1Base.scene,
            collision: this.resources.items.introR1Collision.scene,
            offset: new THREE.Vector3(0, 0, 0),
            rotation: new THREE.Euler(0, 0, 0),
            shadow: { sizeX: 1.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.4 },
            mass: 1.5,
        ...
        this.objects.add({
            base: this.resources.items.introA1Base.scene,
            collision: this.resources.items.introA1Collision.scene,
            offset: new THREE.Vector3(0, 0, 0),
            rotation: new THREE.Euler(0, 0, 0),
            shadow: { sizeX: 1.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.4 },
            mass: 1.5,
        ...
        this.objects.add({
            base: this.resources.items.introH1Base.scene,
            collision: this.resources.items.introH1Collision.scene,
            offset: new THREE.Vector3(0, 0, 0),
            rotation: new THREE.Euler(0, 0, 0),
            shadow: { sizeX: 1.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.4 },
            mass: 1.5,
        ...
        this.objects.add({
            base: this.resources.items.introI2Base.scene,
            collision: this.resources.items.introI2Collision.scene,
            offset: new THREE.Vector3(0, 0, 0),
            rotation: new THREE.Euler(0, 0, 0),
            shadow: { sizeX: 1.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.4 },
            mass: 1.5,
        ...
        // })
        // this.objects.add({
        //     base: this.resources.items.introH2Base.scene,
        //     collision: this.resources.items.introH2Collision.scene,
        //     offset: new THREE.Vector3(0, 0, 0),
        //     rotation: new THREE.Euler(0, 0, 0),
        //     shadow: { sizeX: 1.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.4 },
        //     mass: 1.5,

...
export default class InformationSection
{
    ...
    setLinks()
    {
        ...
        this.links.options = [
            ...
            {
                href: 'mailto:viranchidakhare@gmail.com',
    ...
    setActivities()
    {
        ...
        // Geometry
        this.activities.geometry = new THREE.PlaneGeometry(2 * this.activities.multiplier, 3 * this.activities.multiplier, 1, 1)

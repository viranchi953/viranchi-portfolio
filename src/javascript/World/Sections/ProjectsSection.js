...
export default class ProjectsSection
{
    ...
    setList()
    {
        this.list = [
            {
                name: 'Beyond Braille Mobility Jacket',
                imageSources:
                [
                ...
                link:
                {
                    href: 'https://www.youtube.com/watch?v=1LdElrjfo0k',
                    x: - 4.8,
                    y: - 3.3,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://youtu.be/oHsWHmpPET4?si=mIFB3CZNvI5vsPKA',
                    x: - 4.8,
                    y: - 3.3,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://badassaman4014.github.io/ksp_dashboard/index.html',
                    x: - 4.8,
                    y: - 3.3,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://www.youtube.com/watch?v=rL16adhfV5o',
                    x: - 4.8,
                    y: - 4.5,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://youtu.be/xKoBW3wclHw?si=ppoEJDkCGr0Ihp-o',
                    x: - 4.8,
                    y: - 5.1,
                    halfExtents:
                    {
            ...
            //     link:
            //     {
            //         href: 'https://youtu.be/gFtRrd2NMy4?si=BHg4EJoM-LfzZfaq',
            //         x: - 4.8,
            //         y: - 2,
            //         halfExtents:
            //         {

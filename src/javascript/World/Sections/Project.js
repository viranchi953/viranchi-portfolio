        ...
        if(this.distinctions)
        {
            for(const _distinction of this.distinctions)
            {
                ...
                switch(_distinction.type)
                {
                    ...
                    case '1lakh':
                        base = this.resources.items.projectsDistinctions1LAKHBase.scene
                        collision = this.resources.items.projectsDistinctions1LAKHCollision.scene
                        shadowSizeX = 5
                        shadowSizeY = 1.2
                        break

                    case '5th':
                        base = this.resources.items.projectsDistinctions5THBase.scene
                        collision = this.resources.items.projectsDistinctions5THCollision.scene
                        shadowSizeX = 1.5
                        shadowSizeY = 1.5
                        break
                }
